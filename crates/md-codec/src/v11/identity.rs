...
pub fn compute_wallet_descriptor_template_id(
    d: &Descriptor,
) -> Result<WalletDescriptorTemplateId, V11Error> {
    ...
    crate::v11::tree::write_node(&mut w, &d.tree, kiw)?;
    if let Some(overrides) = &d.tlv.use_site_path_overrides {
        ...
        w.write_bits(u64::from(crate::v11::tlv::TLV_USE_SITE_PATH_OVERRIDES), 5);
        crate::v11::varint::write_varint(&mut w, bit_len as u32);
        let payload = sub.into_bytes();
        let mut subr = crate::v11::bitstream::BitReader::new(&payload);
