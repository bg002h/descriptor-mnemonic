...
**Status:** R0 in progress — R0 RED 0C/4I/4M → folded (I1 decode_payload debug-assert, I2 taptree placeholder coverage, I3 n∈1..=32 + kiw=5, I4 dead_code; M1-M4) → R1 pending. Review: `design/agent-reports/md-test-hardening-spec-R0-review.md`.
