...
- **Status:** `landed (NO-BUMP)` on `main`; **a PATCH release `md-codec 0.39.1` + crates.io publish is required at toolkit P6** before the toolkit can consume the accessor (toolkit currently pins `md-codec 0.39`). **Tier:** `feature` (cross-repo companion).
